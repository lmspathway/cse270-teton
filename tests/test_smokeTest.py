...
class TestSmokeTest():
  ...
  def test_homeTest(self):
    ...
    self.driver.set_window_size(1420, 936)
  ...
  def test_directoryTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1208, 911)
  ...
  def test_adminTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1247, 911)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.vars["incorrect"] = self.driver.find_element(By.ID, "username").get_attribute("value")
    self.vars["incorrect"] = self.driver.find_element(By.ID, "password").get_attribute("value")
  ...
  def test_joinTest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1164, 911)
